...
const AllRooms = () => {
   ...
   return (
      // Creating Heading and small description in the left side of the page
            ...
            <div className='flex-1'>
               {roomsDummyData.map((room) => (
                  <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                     {/*Adding on click property in room images */}
                     <img
                     ...
                     <div className='md:w-1/2 flex flex-col gap-2'>
                        {/*Hotel City name and add clicking property in Hotel Name to navigate it hotel details page */}
                        ...
                        <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                         ...
                         {/* Adding Pricing in Card , room price per night*/}
                        <div>
