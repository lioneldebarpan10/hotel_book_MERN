   ...
   return (
      <div className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
         <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
            ...
            {/*Left side image */}
            <img src={assets.regImage} alt="registration-image" className='w-1/2 hidden:md-block rounded-xl' />

            {/*Registration form in the right side */}
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
               <img src={assets.closeIcon} alt="close-icon" className='absolute h-4 w-4 top-4 right-4 cursor-pointer' />
