...
const HotelCard = ({room , index}) => {
   return (
      <Link to = {'/rooms/' + room._id} onClick = {() => scrollTo(0,0)} key={room._id} className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow[0px_4px_4px'> 
      
         {/* Hotel Image and Best Seller Tag*/}
         ...
         <div className = 'p-4 pt-5'>
            {/* Card Hotel Name and Rating div*/}
            <div className = 'flex items-center justify-between'>
               <p className = 'font-medium font-playfair text-xl text-gray-800'>{room.hotel.name}</p>
            ...
            {/* Card price and book now button*/}
